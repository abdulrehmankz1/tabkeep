    ...
    <SafeAreaView style={styles.screen} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
          ...
          {!settled && (
            <Text
              style={[
                ...
                { color: balance > 0 ? colors.moneyIn : colors.moneyOut },
              ]}
            >
        ...
        <View style={styles.actionRow}>
          ...
          >
            <Icon name="arrowout" size={16} color={colors.moneyOut} />
            <Text style={[styles.actionText, { color: colors.moneyOut }]}>You gave</Text>
          </Pressable>
          <Pressable
            style={styles.actionButton}
            onPress={() => safePush(`/add-transaction?personId=${person.id}&direction=received`)}
          >
            <Icon name="arrowin" size={16} color={colors.moneyIn} />
            <Text style={[styles.actionText, { color: colors.moneyIn }]}>You got</Text>
          </Pressable>
        </View>
            ...
            <View key={entry.id} style={[styles.timelineRow, index === 0 && styles.timelineRowFirst]}>
              <View style={styles.timelineIconWrap}>
                <Icon
                  ...
                  size={15}
                  color={entry.direction === 'gave' ? colors.moneyOut : colors.moneyIn}
                />
              </View>
